...
export default {
  ...
  /*潮品优惠券*/
  cpSelectCoupon (params) {
    return request('/yunhe/wechat/activitylimit/selectActionCoupon', params)
  },
  /*领取潮品优惠券*/
  selectCpCoupon (params) {
    return request('/yunhe/wechat/activitylimit/saveLimitActionCoupon', params)
  },
  /*潮品精选*/
  virtuagoodList (params) {
    return request('/yunhe/wechat/activitylimit/virtualgoodlist', params)
  },
  /*潮品限时购*/
  deadlinegoods (params) {
    return request('/yunhe/wechat/goods/deadlinegoods', params)
  },
  /*潮品金牌店员*/
