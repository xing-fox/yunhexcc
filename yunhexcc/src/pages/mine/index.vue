...
=======
	<div class="page">
		...
		<div class="order">
			<div class="title bor-1px-b" data-current="0" @click="goToOrderList">
				<span>我的订单</span>
				<i class="icon_right"></i>
			</div>
			<ul class="orderList">
				<li data-current="1" @click="goToOrderList">
					<i class="icon icon_order1"></i>
					<p>待付款</p>
				</li>
				<li data-current="2" @click="goToOrderList">
					<i class="icon icon_order2"></i>
					<p>待发货</p>
				</li>
				<li data-current="3" @click="goToOrderList">
					<i class="icon icon_order3"></i>
					<p>待收货</p>
				</li>
				<!-- <li>
		...
		methods: {
			...
			goToOrderList(e) {
				...
				if(e.currentTarget.dataset.current) {
					wx.navigateTo({
						url: '/pages/order/main?currentIndex=' + e.currentTarget.dataset.current
					})
				}
...
>>>>>>> bffaee8ba7928e2b4f537d1574c429b833baad9f
