<template>
  <div class="page">
    ...
    <div class="dispatch">
      ...
      <div class="proIntro bor-1px-b" v-for="(item, index) in dataList.goodsPOList" :key="index">
        <div class="proImg">
...
export default {
  ...
  methods: {
    ...
    submitFunc () {
      ...
      this.$http.generateOrder({
        data: JSON.stringify({
          'cart_ids': this.cardIds,
  ...
  onShow () {
    ...
    wx.getStorage({
      ...
      success: function(res) {
        ...
        self.$http.submitcart({
          data: JSON.stringify({
            'cart_ids': self.cardIds
          }),
          'openid': self.openId
        }).then(res => {
